...
// source: phar:///Users/darod/php_serializer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon
...
class Container_6867dda431 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6867dda431 $container)
			{
	...
	public function createServiceContainer(): Container_6867dda431
	{
		return $this;
	}
